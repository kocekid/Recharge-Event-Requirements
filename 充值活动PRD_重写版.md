...
```text
有效金币到账事件
→ 按活动开始时间所在时区落入日/周/月周期（当日0点/当周周一0点/当月1号0点起）
→ 按用户分区累计
→ 触发档位达成判断
...
<span style="color:red"><strong>【核心规则】充值活动上线时，统计的时间范围为活动开始时间所在时区的：</strong></span>
- <span style="color:red"><strong>月周期：当月1号 00:00:00 起</strong></span>
- <span style="color:red"><strong>周周期：当周周一 00:00:00 起</strong></span>
- <span style="color:red"><strong>日周期：当日 00:00:00 起</strong></span>
...
|---|---|---|---|
| 活动中途上线（5月8日 15:00） | 5月8日 15:00 | 5月8日 Daily（从当日 00:00 起） | `[5月8日 15:00, 5月9日 00:00)` |
| 活动中途上线（5月8日 15:00） | 5月8日 15:00 | 5月 Weekly（从当周周一 00:00 起，即5月5日） | `[5月8日 15:00, 下周一 00:00)` |
| 活动中途上线（5月8日 15:00） | 5月8日 15:00 | 5月 Monthly（从当月1日 00:00 起） | `[5月8日 15:00, 6月1日 00:00)` |
| 活动月底结束 | 5月20日 23:59:59 | 5月 Monthly | `[5月1日 00:00, 5月20日 23:59:59]` |
| 活动覆盖整月 | 5月1日 00:00 ~ 6月1日 00:00 | 5月 Monthly | `[5月1日 00:00, 6月1日 00:00)` |

**说明**：
- 活动上线时，统计从活动开始时间所在的自然周期起点开始（当月1号0点、当周周一0点、当日0点）。
- 但实际有效统计窗口取活动有效期与自然周期的交集，即活动开始时间之后的充值才计入。
- 活动上线前的充值（即使落在当月/当周/当日范围内）不计入活动累计。
...
| `period_start_at` | 周期开始时间 | 活动开始时间所在时区的当日0点/当周周一0点/当月1号0点 | 服务端周期计算 |
| `period_end_at` | 周期结束时间 | 活动开始时间所在时区的次日0点/下周一0点/次月1号0点 | 服务端周期计算 |
...
口径说明：客户端与后台统计口径一致，均按活动开始时间所在时区的周期内"有效金币到账事件"累计（月周期从当月1号0点起、周周期从当周周一0点起、日周期从当日0点起），不按订单创建时间、不按支付发起时间。
...
| 9 | 活动上线首日是否从当天 0 点补算 | 从活动开始时间所在的自然周期起点开始（当月1号0点、当周周一0点、当日0点），但实际统计窗口取活动有效期交集 | 影响首日统计 |
